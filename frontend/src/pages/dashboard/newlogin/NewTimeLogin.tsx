    ...
    return (
        <div className={styles.newArea}>
            <div className={styles.header}>
                <img src={arrowLeft} alt="Retour" className={styles.backArrow} onClick={() => navigate('/newarea/time')}/>
                <h1>time</h1>
            </div>
            ...
            <button className={styles.button} onClick={() => navigate('/newarea/time/newtime')}>Activer time</button>
        </div>
    );
};

export default NewTimeLogin;