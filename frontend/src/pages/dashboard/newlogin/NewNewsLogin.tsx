    ...
    return (
        <div className={styles.newArea}>
            <div className={styles.header}>
                <img src={arrowLeft} alt="Retour" className={styles.backArrow} onClick={() => navigate('/newarea/news')}/>
                <h1>news</h1>
            </div>
            ...
            <button className={styles.button} onClick={() => navigate('/newarea/news/newnews')}>Activer news</button>
        </div>
    );
};

export default NewNewsLogin;