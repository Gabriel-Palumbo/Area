...
const Quotes_new = () => {
    ...
    return (
        <div className={styles.newArea}>
            ...
            <p className={styles.description}>Get the latest quotes information from your area and way more !</p>
            <button className={styles.button} onClick={() => navigate('/newarea/quotes/newquotes')}>Activer les quotes</button>
        </div>
    );
};

export default Quotes_new;
