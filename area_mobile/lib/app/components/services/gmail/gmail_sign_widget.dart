...
class GmailSignUpWidget extends StatefulWidget {
  final String serviceName;
  final Map<String, dynamic> serviceData;
  const GmailSignUpWidget(
      {super.key, required this.serviceName, required this.serviceData});

  @override
  State<StatefulWidget> createState() => GmailSignUpWidgetState();
}

class GmailSignUpWidgetState extends State<GmailSignUpWidget> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(
      Uri.parse(
          'https://firebasestorage.googleapis.com/v0/b/area-2-e77d3.appspot.com/o/video-google.mp4?alt=media&token=e74f4603-3b11-4684-8147-5af14a39d1c7'),
    )
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
