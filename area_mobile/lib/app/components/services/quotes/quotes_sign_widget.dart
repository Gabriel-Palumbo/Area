...
class QuotesSignUpWidget extends StatefulWidget {
  final String serviceName;
  final Map<String, dynamic> serviceData;
  const QuotesSignUpWidget({
    super.key,
  ...
  @override
  State<StatefulWidget> createState() => QuotesSignUpWidgetState();
}

class QuotesSignUpWidgetState extends State<QuotesSignUpWidget> {
  ...
  late QuotesApi quotesApi;

  QuotesApi setQuotesApi() {
    final tokenAuth = getStoredToken();
    return QuotesApi('Bearer $tokenAuth');
  }
                    ...
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Les mots peuvent avoir beaucoup de pouvoir. Recevez des quotes motivation avec Quotes.",
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      Text(
                        "Afin de terminer la connection de Quotes, validez celle-ci:",
                        style: areaTheme.textWhite_20,
                        textAlign: TextAlign.start,
                      ),
                      const SizedBox(height: 20),
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            await quotesApi.storeQuotesInfos(
                              selectedMessagerie!,
                            );
