...
import 'package:area_mobile/backend/api/services/coincap_api.dart';
...
class CoinMarketCapSignUpWidget extends StatefulWidget {
  final String serviceName;
  final Map<String, dynamic> serviceData;
  const CoinMarketCapSignUpWidget({
    super.key,
  ...
  @override
  State<StatefulWidget> createState() => CoinMarketCapSignUpWidgetState();
}

class CoinMarketCapSignUpWidgetState extends State<CoinMarketCapSignUpWidget> {
  ...
  late CoinCapApi coincapApi;

  CoinCapApi setCoinCapApi() {
    final tokenAuth = getStoredToken();
    return CoinCapApi('Bearer $tokenAuth');
  }
  ...
  void initState() {
    ...
    _controller =
        VideoPlayerController.networkUrl(
            Uri.parse(
              'https://firebasestorage.googleapis.com/v0/b/area-2-e77d3.appspot.com/o/video-coinmarketcap.mp4?alt=media&token=25fad341-8786-41bd-b6be-13f1bfc73165',
            ),
          )
          ..initialize().then((_) {
            setState(() {});
                    ...
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Activez les services CoinMarketCap et recevez des infos en direct sur les valeurs ​​actuels des crypto-monnaies par capitalisation boursière.",
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      Text(
                        "Afin de terminer la connection de CoinCap, validez celle-ci:",
                        style: areaTheme.textWhite_20,
                        textAlign: TextAlign.start,
                      ),
                      const SizedBox(height: 20),
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            await coincapApi.storeCoinCapApiInfos(
                              selectedMessagerie!,
                            );
